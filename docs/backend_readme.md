...
3. **Sistema de transacciones básico**:
   - Modelo completo
   - Endpoint para **creación** de transacciones (`POST /api/transactions`). (Endpoints para leer, actualizar y otras operaciones están en desarrollo).
   - Soporte para diferentes tipos de transacciones (en desarrollo, lógica principal pendiente).
