...
import { ContactUpdateData, ContactResponse, ContactFormData } from '../../types/contact.types'; // ContactFormData podría necesitar ajuste o ser importada de ContactForm si se exporta desde allí
...
const EditContactPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchContact = async () => {
            ...
            try {
                ...
                const apiError = err.response?.data?.message || 'Error al cargar el contacto.';
                setError(apiError);
    ...
    const handleSubmit = async (data: ContactFormData) => {
        ...
        try {
            ...
            const apiError = err.response?.data?.message || 'Error al actualizar el contacto.';
            setError(apiError);
            toast.error(apiError);
        } finally {
            setIsLoading(false);
