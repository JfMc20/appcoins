...
import type { CreateFundingSourceData, UpdateFundingSourceData } from '../../types/fundingSource.types'
    ...
    if ('currentBalance' in data) {
      ...
      try {
        ...
        if (err instanceof Error) {
          const apiError = err.message || 'Error al crear la fuente de fondos.'
          setErrorMessage(apiError)
          toast.error(apiError)
        } else {
          setErrorMessage('Error desconocido al crear la fuente de fondos.')
          toast.error('Error desconocido al crear la fuente de fondos.')
        }
      } finally {
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Crear Nueva Fuente de Fondos</h1>
