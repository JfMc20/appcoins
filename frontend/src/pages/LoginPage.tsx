        ...
        <Card className="px-4 py-8 sm:px-10 bg-gray-50 dark:bg-gray-800">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <Link
                to="/register"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-gray-700 hover:text-gray-900 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-600"
              >
                Regístrate aquí
              </Link>
            </div>
