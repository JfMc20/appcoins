...
import type { RegisterData, RegistrationStatusResponse } from '../types/auth.types'
...
const RegisterPage: React.FC = () => {
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <Card className="px-4 py-8 sm:px-10 bg-gray-50 dark:bg-gray-800">
            <div className="text-center">
              ...
              <Button onClick={toggleTestUserDetails} variant="secondary" fullWidth className="mb-4">
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-white">Registrarse</h2>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {registrationSuccess && (
              <div className="rounded-md bg-green-50 dark:bg-green-900/20 p-4">
                <div className="flex">
                  <div className="ml-3">
                    <p className="text-sm text-green-700 dark:text-green-400">{registrationSuccess}</p>
                  </div>
                </div>
              </div>
            )}
